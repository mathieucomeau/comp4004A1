/*
 * LibrarianRemoveTitleTest class
 * Mathieu Comeau Oct 12 2017
 * 
 * This is a STORY TEST class that tests user story #3
 */
...
public class LibrarianRemoveTitleTest {

	
	@Test
	public void testLibrarianRemoveTitle() 
	{
		...
		//Step ii: librarian chooses Delete Title option
		ServerOutput expected2 = new ServerOutput("Please Input Title Info:'ISBN'", OutputHandler.DELETETITLE);
		ServerOutput result2 = testIH.processInput("delete title", OutputHandler.CLERK);
		...
		Output result3 = testOH.deleteTitle("9781442667181");
