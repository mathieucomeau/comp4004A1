/*
 * LibrarianLogOutTest class
 * Mathieu Comeau Oct 12 2017
 * 
 * This is a STORY TEST class that tests user story #11
 */
...
public class LibrarianLogOutTest {
	...
	public void testLibrarianLogOut() 
	{
		...
		//Step ii: librarian logs out
		ServerOutput expected3 = new ServerOutput("Successfully Log Out!", InputHandler.WAITING);
		ServerOutput result3 = testIH.processInput("log out", OutputHandler.CREATETITLE);
